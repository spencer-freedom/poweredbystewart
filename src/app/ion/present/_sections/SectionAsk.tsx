...
const PHASES = [
  {
    ...
    price: "$1,500 / week",
    bullets: [
      "Spencer in the building 1–1.5 days a week, 12–26 weeks",
      "Your playbook, written with Kenny — the schema is what makes Stewart yours",
      "Stewart reading your calls in real time",

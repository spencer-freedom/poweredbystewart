...
function injectProductsIntoEmail(html: string, gridHtml: string): string {
                    ...
                    >
                      ...
                      {p.badge && (
                        <span className={`absolute -top-1.5 -right-1.5 px-1.5 py-0.5 rounded text-[9px] font-bold ${
                          p.badge === "Best Seller" ? "bg-green-500/20 text-green-400" : "bg-green-500/20 text-green-400"
                        }`}>
                          {p.badge}
                        </span>
                      )}
